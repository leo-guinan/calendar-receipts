...
Progress: 9/10 tests passed (84% weighted).

Subtasks / artifact gates:
- [x] measurement-run-baseline-captured — expected at least 1 matching receipt(s); observed 1
- [x] saved-report-created-captured — expected at least 1 matching receipt(s); observed 2
- [x] permalink-reconstruction-captured — expected at least 1 matching receipt(s); observed 1
- [x] provenance-inspection-captured — expected at least 1 matching receipt(s); observed 1
- [x] fork-lineage-ux-artifact-captured — expected at least 1 matching receipt(s); observed 1
- [x] full-walkthrough-captured — expected at least 1 matching receipt(s); observed 1
- [x] full-walkthrough-names-required-experience — expected every matching receipt field 'user_experience' to contain 'run measurement, save report, open permalink in a fresh browser, fork report'; matched 1, failures []
- [x] provenance-visible-in-artifacts — expected every matching receipt field 'evidence' to contain 'provenance'; matched 7, failures []
- [x] fork-lineage-shows-parent-id — expected every matching receipt field 'evidence' to contain 'parent_id'; matched 1, failures []
